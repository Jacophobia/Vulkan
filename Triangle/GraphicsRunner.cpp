...
VkImageView GraphicsRunner::create_image_view(VkImage image, VkFormat format, VkImageAspectFlags aspect_flags)
{
...
void GraphicsRunner::load_model()
{
    ...
    if (!LoadObj(&attrib, &shapes, &materials, &warn, &err, model_path_.c_str()))
    {
